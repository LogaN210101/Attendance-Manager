    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()){
            ...
            case R.id.item4:
            {
                ...
                alt.setTitle("Readme")
                        .setCancelable(false)
                        .setMessage("Thank You for Installing Attendance Manager. Teachers can give attendance and view attendance of any particular section at a time. Students need to be very careful while registering their subjects for that semester in the beginning. If you do not have any data for a particular field, do fill it with a \"NA\"  Students have got option to change their subjects after semester, which will reset the last attendances.They can add or remove current subjects without affecting the attendance. Please note,if you change your department or college or section then you need to add subjects once more for the current class. In case of any abnormal behaviour of the android application or feedback, please contact the developers. Your participation in further developing this app is highly appreciated.\n" +
                                "Thank you,\n" +
                                "Team Developers")
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
